...
<h1 style="text-align:center;">Please select at least 1 video to extract!!</h1>

<router-link to="/exercise" @click.prevent="make_all_gif()">
<h1 class="next" style="text-align:center;">MAKE ALL TO GIF</h1>
...
<section class="page-content">
  ...
  <div calss="app">
  <p v-for=" (value,index) in list_videos.All_Videos" v-bind:key="value">

    <input
      type="text"
      v-model="post.video"
      :key="index"
      @click.prevent="make_gif" method="post"
    />
    </p>
    </div>
    ...
    <li v-for="(value) in list_videos.All_Videos" v-bind:key="value">
      <div class="box">
      <input type="checkbox" value="value" v-model="post.video" v-bind:key="value">
      <span @click.prevent="make_gif" method="post">{{value}}</span>
   </div>
    </li>
...
export default {
    ...
    methods: {
      ...
      async get_videos(){
        const path = 'http://localhost:80/list_videos'
        axios.get(path)
        .then((response) =>{
          this.list_videos = response.data
          // this.amount = list_videos.length
   ...
   check(){
    ...
    async make_gif(o){
      const data = { video: o }
        const path = 'http://localhost:80/make_gif'
        console.log(o)
        axios.post(path,data)

        .then((response) =>{
          console.log(response)
          console.log("Make_gif")
